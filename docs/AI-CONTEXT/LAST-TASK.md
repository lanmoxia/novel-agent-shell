...
- 最近任务编号：WENYAN-GENERALIZE-003-PHASE6-LIGHT-REVISION
- 最近任务名称：《司马光》Phase 6 轻量修订，处理 Phase 5 审查 P2 问题
- 最近任务状态：已完成 Phase 6 轻量修订，未进入 Phase 7/8，未锁稿
- 更新时间：2026-05-30

## 本轮修改摘要

- 新增《司马光》Phase 6 轻量修订记录 `projects/wenyan-generalize-sima-guang-001/revisions/phase6-light-revision-notes.md`。
- 新增归档 `docs/AI-CONTEXT/archive/WENYAN-GENERALIZE-003-PHASE6-LIGHT-REVISION.md`。
- 修订 `projects/wenyan-generalize-sima-guang-001/scripts/SMOKE-DRAFT.md`。
...
- 当前阶段：Phase 6。
- 当前状态：`phase6_revised`。
- 已修订 Phase 6 烟测草案：`projects/wenyan-generalize-sima-guang-001/scripts/SMOKE-DRAFT.md`。
- 已生成 Phase 6 修订记录：`projects/wenyan-generalize-sima-guang-001/revisions/phase6-light-revision-notes.md`。
- 已处理 Phase 5 P2：观看张力、儿童化判断、群儿调度、安全化表达和学习闭环。
- 仍保留 P2：教材版本、目标年级、最终时长和原文采用版本正式化前待确认。
- 本轮未进入 Phase 7 / 8。
- 本轮未锁稿。
- 本轮未生成 `reviews/final-review.md`、`locked/FINAL-SCRIPT.md` 或锁稿 manifest。
...
该方向必须等待用户明确确认后执行。不得自动进入 Phase 7，也不得直接进入 Phase 8、锁稿或视频链路。
